...
def plot_loss(epoch):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('images/WGAN-BN/Dloss_epoch_%d.png' % epoch)
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('images/WGAN-BN/Gloss_epoch_%d.png' % epoch)
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('images/WGAN-BN/loss_epoch_%d.png' % epoch)
...
def plotGeneratedImages(epoch, example=100, dim=(10, 10), figsize=(10, 10)):
    ...
    if not os.path.exists('images/WGAN-BN'):
        os.mkdir('images/WGAN-BN')
    plt.savefig('images/WGAN-BN/epoch_%d.png' % epoch)


def saveModels(epoch):
    if not os.path.exists('Model/WGAN-BN'):
        os.mkdir('Model/WGAN-BN')
    generator.save('Model/WGAN-BN/generated_epoch_%d.h5' % epoch)
    discriminator.save('Model/WGAN-BN/discriminated_epoch_%d.h5' % epoch)
